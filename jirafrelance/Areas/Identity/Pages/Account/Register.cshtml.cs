...
namespace jirafrelance.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async void OnGet(string roles,string returnUrl = null)
        {
            Roles = roles;
            ReturnUrl = returnUrl;
        ...
        public async Task<IActionResult> OnPostAsync(string roles, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    IdentityResult roleResult = await _userManager.AddToRoleAsync(user, roles??"Freelancer");
