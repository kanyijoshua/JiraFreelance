...
{
    public partial class datetimefx : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    certification_name = table.Column<string>(maxLength: 200, nullable: false),
                    TblUserPkUserId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    bid_time = table.Column<string>(maxLength: 50, nullable: false),
                    bid_award_time = table.Column<string>(maxLength: 100, nullable: true),
                    fk_bid_user = table.Column<string>(nullable: false),
                    bid_offer_information = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    job_attachment_file_path = table.Column<string>(maxLength: 500, nullable: false),
                    job_attachment_file_name = table.Column<string>(maxLength: 300, nullable: false),
                    job_attachment_download_name = table.Column<string>(maxLength: 300, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    wkspc_starttime = table.Column<DateTime>(maxLength: 100, nullable: false),
                    wkspc_expectend_endtime = table.Column<DateTime>(maxLength: 100, nullable: false),
                    wkspc_actual_endtime = table.Column<DateTime>(maxLength: 200, nullable: false),
